...
const Comment: React.FC<IComments> = ({userId, userName, comment}) => {
  return (
    <div>
      <div tw="flex items-center justify-center w-screen h-screen bg-white dark:bg-gray-800">
        <div tw="bg-white dark:bg-gray-800 text-black dark:text-gray-200 p-4 antialiased flex max-w-lg">
          <UserPhoto id={userId} />
          <div>
            <div tw="bg-gray-100 dark:bg-gray-700 rounded-3xl px-4 pt-2 pb-2.5">
              ...
              <div tw="leading-snug md:leading-normal"> {comment} </div>
            </div>
          </div>
        </div>
      </div>
